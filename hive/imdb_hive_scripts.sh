...
hive -e "create table if not exists title_principal_pq(tconst string, ordering int, nconst string, category string, job string, characters string) stored as Parquet;"
